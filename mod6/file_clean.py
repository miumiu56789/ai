...
# Load your CSV
df = pd.read_csv(r"C:\Users\Admin\ai\Mod3\Nigerian_Fraud_processed_email_10.csv", encoding='utf-8')
...
# Save cleaned CSV
output_path = r"C:\Users\Admin\ai\Mod3\Nigerian_Fraud_processed_email_11.csv"
